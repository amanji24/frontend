...
<div   className="col-4" style={{paddingTop: '0.5%'}} >
                ...
                <PricingSlot  title='Festive Marketplace'>
               
                <div id='price1' >
                <div >
                      <div style={{paddingBottom:'7%'}}>
                      <h12 style={{marginLeft:'-10%'}}>UCC Festive Marketplace </h12>
                     
                      </div >
                      <div style={{paddingBottom:'7%'}}>
                      <h13 >Thursday 3-7 and Friday 8:30-5:00</h13>
                      </div>
                      <div style={{paddingBottom:'7%'}}>
                      <h13 >A bunch of food and gifts and shopping</h13>
                      </div>
                      <div>
                      <h15 style={{fontSize:'20px', color:'green'}}><b>Make sure to come out</b></h15>
                      </div>
                      <h15 style={{fontSize:'20px', color:'green'}}><b>Support UCC</b></h15>
